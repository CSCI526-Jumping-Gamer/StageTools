...
result = {}
result["Level 1"] = {}
result["Level 1"]["PLAYERXPOSITION"] = []
result["Level 1"]["PLAYERYPOSITION"] = []
print(result)
for ind in df.index:
    ...
    # else:
    #     result[lvl][crd] = 1
    result["Level 1"]["PLAYERXPOSITION"].append(x)
    result["Level 1"]["PLAYERYPOSITION"].append(y)
...
xpoints = result["Level 1"]["PLAYERXPOSITION"]
ypoints = result["Level 1"]["PLAYERYPOSITION"]

plt.plot(xpoints, ypoints, 'o')
plt.axis('square')
plt.grid(True)
plt.title('Death Position at level 1', fontsize=14)
plt.show()