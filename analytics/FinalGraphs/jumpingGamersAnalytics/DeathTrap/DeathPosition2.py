...
result = {}
result["Level 2"] = {}
result["Level 2"]["PLAYERXPOSITION"] = []
result["Level 2"]["PLAYERYPOSITION"] = []
print(result)
for ind in df.index:
    ...
    # else:
    #     result[lvl][crd] = 1
    result["Level 2"]["PLAYERXPOSITION"].append(x)
    result["Level 2"]["PLAYERYPOSITION"].append(y)
...
xpoints = result["Level 2"]["PLAYERXPOSITION"]
ypoints = result["Level 2"]["PLAYERYPOSITION"]

plt.plot(xpoints, ypoints, 'o')
plt.axis('square')
plt.grid(True)
plt.title('Death Position at level 2', fontsize=14)
plt.show()