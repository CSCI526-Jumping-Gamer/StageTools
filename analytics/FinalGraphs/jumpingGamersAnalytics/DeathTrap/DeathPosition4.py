...
result = {}
result["Level 4"] = {}
result["Level 4"]["PLAYERXPOSITION"] = []
result["Level 4"]["PLAYERYPOSITION"] = []
print(result)
for ind in df.index:
    ...
    # else:
    #     result[lvl][crd] = 1
    result["Level 4"]["PLAYERXPOSITION"].append(x)
    result["Level 4"]["PLAYERYPOSITION"].append(y)
...
xpoints = result["Level 4"]["PLAYERXPOSITION"]
ypoints = result["Level 4"]["PLAYERYPOSITION"]

plt.plot(xpoints, ypoints, 'o')
plt.grid(True)
plt.title('Death Position at level 4', fontsize=14)
plt.show()