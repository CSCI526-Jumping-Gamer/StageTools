...
result = {}
result["Level 7"] = {}
result["Level 7"]["PLAYERXPOSITION"] = []
result["Level 7"]["PLAYERYPOSITION"] = []
print(result)
for ind in df.index:
    ...
    # else:
    #     result[lvl][crd] = 1
    result["Level 7"]["PLAYERXPOSITION"].append(x)
    result["Level 7"]["PLAYERYPOSITION"].append(y)
...
xpoints = result["Level 7"]["PLAYERXPOSITION"]
ypoints = result["Level 7"]["PLAYERYPOSITION"]

plt.plot(xpoints, ypoints, 'o')
plt.axis('square')
plt.grid(True)
plt.title('Death Position at level 7', fontsize=14)
plt.show()