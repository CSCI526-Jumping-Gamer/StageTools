...
card = ['Triple Jump', 'Double Jump', 'Zero Gravity', 'Slingshot Helper', 'Flash (Running Speed + 100%)', 'LunarGravity (Gravity -50%)', 'LightWeight (Gravity -25%)', 'Running Speed + 40%', 'Invincible', 'Bullet Time', 'Jumping Height + 40%', 'Three-Times Shield']
