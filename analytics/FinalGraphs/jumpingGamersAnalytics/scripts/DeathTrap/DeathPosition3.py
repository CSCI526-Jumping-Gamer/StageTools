...
result = {}
result["Level 3"] = {}
result["Level 3"]["PLAYERXPOSITION"] = []
result["Level 3"]["PLAYERYPOSITION"] = []
print(result)
for ind in df.index:
    ...
    # else:
    #     result[lvl][crd] = 1
    result["Level 3"]["PLAYERXPOSITION"].append(x)
    result["Level 3"]["PLAYERYPOSITION"].append(y)
...
xpoints = result["Level 3"]["PLAYERXPOSITION"]
ypoints = result["Level 3"]["PLAYERYPOSITION"]

plt.plot(xpoints, ypoints, 'o')
plt.axis('square')
plt.grid(True)
plt.title('Death Position at level 3', fontsize=14)
plt.show()