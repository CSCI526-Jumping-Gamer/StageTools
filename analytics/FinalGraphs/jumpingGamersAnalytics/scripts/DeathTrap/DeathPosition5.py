...
result = {}
result["Level 5"] = {}
result["Level 5"]["PLAYERXPOSITION"] = []
result["Level 5"]["PLAYERYPOSITION"] = []
print(result)
for ind in df.index:
    ...
    # else:
    #     result[lvl][crd] = 1
    result["Level 5"]["PLAYERXPOSITION"].append(x)
    result["Level 5"]["PLAYERYPOSITION"].append(y)
...
xpoints = result["Level 5"]["PLAYERXPOSITION"]
ypoints = result["Level 5"]["PLAYERYPOSITION"]

plt.plot(xpoints, ypoints, 'o')
plt.axis('square')
plt.grid(True)
plt.title('Death Position at level 5', fontsize=14)
plt.show()